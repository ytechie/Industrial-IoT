...
namespace Microsoft.Azure.IIoT.OpcUa.Security.Services {
    ...
    public class SecurityNotificationTests {
        ...
        public void SendSecurityAlertWhenEndpointModeUnsecure() {
            ...
            var certEncoded = Convert.FromBase64String(certString);
            ...
            using (var mock = AutoMock.GetLoose()) {
                ...
                // Run
                var t = service.OnEndpointNewAsync(null, endpoints.FirstOrDefault());

                // Assert
                Assert.True(t.IsCompletedSuccessfully);
                mockIotTelemetryService.Events.TryTake(out var eventMessage);
                eventMessage.Message.Properties.TryGetValue(SystemProperties.InterfaceId, out var val);
