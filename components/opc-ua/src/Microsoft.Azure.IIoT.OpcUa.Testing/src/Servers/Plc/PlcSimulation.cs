...
namespace OpcPlc
{
    public partial class PlcNodeManager
    {
        ...
        private void ValueGenerator(object state)
        {
            ...
            RandomSignedInt32 = _random.Next(Int32.MinValue, Int32.MaxValue);
            RandomUnsignedInt32 = (UInt32)_random.Next();
