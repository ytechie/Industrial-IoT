...
namespace Microsoft.Azure.IIoT.Modules.OpcUa.Twin.v2.Twin.Endpoint {
    ...
    public class TwinValueReadScalarTests : IClassFixture<TwinModuleFixture> {

        public TwinValueReadScalarTests(TestServerFixture server, TwinModuleFixture module) {
            _server = server;
            _module = module;
        }
